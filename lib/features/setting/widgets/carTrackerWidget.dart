...
import 'package:car_tracking/features/setting/widgets/bottomsheetForCDeleteCar.dart';
...
class CarTrackerCardWidget extends StatefulWidget {
  CarTrackerModel? model;
  CarTrackerCardWidget({this.model});

  @override
  State<CarTrackerCardWidget> createState() => _CarTrackerCardWidgetState();
}

class _CarTrackerCardWidgetState extends State<CarTrackerCardWidget> {
  @override
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${(widget.model!.tracker.isNotEmpty) ? (widget.model!.tracker[0].carSpeed ?? 0) : 0} Km/h',
                      style: TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.bold,
                      ),
              ...
              children: [
                Expanded(
                  child: customSelectButton(
                    ...
                    ontap: () {
                      CustomBottomSheetForCar(context ,onTap: ()async{
                       await dashboradCubit.deleteCar(widget.model!.id);
